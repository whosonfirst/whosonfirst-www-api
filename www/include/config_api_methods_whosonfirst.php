	...
	$GLOBALS['cfg']['api']['methods'] = array_merge(array(
		...
		'whosonfirst.places.getByPolyline' => array(
			...
			"library" => "api_whosonfirst_places",
				...
				array("name" => "valhalla", "description" => "Signal that polyline is encoded to six decimal points (as generated by Mapzen Valhalla)", "documented" => 1, "required" => 0, "example" => "1"),
